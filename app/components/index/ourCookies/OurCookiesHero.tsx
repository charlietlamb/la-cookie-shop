...
export default function OurCookiesHero() {
  return (
    <div className="relative w-full pb-20">
      <div className="bg-pink absolute top-0 right-0 left-0 z-0 w-full h-[300px]"></div>
      <OurCookiesHeroBackground />
      <div className="padding-main">
        <div className="relative z-10 h-[300px] flex flex-col items-center gap-4 justify-center mb-[200px]">
          <motion.h1
