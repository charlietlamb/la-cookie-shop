...
export default function StoryTabs() {
  ...
  return (
    <motion.section
      ...
      className="bg-light md:py-16 text-dark w-full py-8"
    >
      <div className="padding-main">
        <h3 className="font-cardo md:mb-6 md:text-3xl mb-4 text-2xl text-center">
          Our Process
        </h3>
        <Tabs
        ...
        >
          <TabsList className="grid w-full grid-cols-3 gap-2 font-light bg-green-600">
            ...
            <TabsTrigger
              value="quality"
              className="hidden md:block font-cardo text-dark data-[state=active]:bg-white data-[state=active]:text-dark text-base md:text-lg"
            >
              Quality Control
            </TabsTrigger>
            <TabsTrigger
              value="quality"
              className="block md:hidden font-cardo text-white data-[state=active]:bg-white data-[state=active]:text-dark text-base md:text-lg"
            >
              Quality
            </TabsTrigger>
          </TabsList>
                  ...
                  <div className="md:flex-row md:gap-6 flex flex-col items-center gap-4">
                    ...
                    <div className="text-dark">
                      <p className="md:text-lg mb-4 text-base font-light">
                        ...
                        exceptional ingredients. Our team scours Europe for the
                        finest ingredients - from rich, French butter to
                      ...
                      <p className="md:text-lg text-base font-light">
                        ...
                        our passion for quality, ensuring that every ingredient
                        that goes into our cookies meets our exacting standards.
                        This commitment to sourcing the best ingredients is what
                        sets our cookies apart and gives them their unique,
                        irresistible flavor.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="md:flex-row md:gap-6 flex flex-col items-center gap-4">
                    ...
                    <div className="text-dark">
                      <p className="md:text-lg mb-4 text-base font-light">
                        ...
                        form. Our skilled bakers combine time-honored techniques
                        with innovative approaches to create cookies that are
                        not just delicious, but also visually stunning.
                      </p>
                      <p className="md:text-lg text-base font-light">
                        Each cookie is carefully crafted by hand, ensuring that
                        every batch meets our high standards. From precisely
                        measuring ingredients to perfecting the bake time, our
                        artisans pay attention to every detail. This meticulous
                        process is what transforms simple ingredients into
                  ...
                  <div className="md:flex-row md:gap-6 flex flex-col items-center gap-4">
                    ...
                    <div className="text-dark">
                      ...
                      <p className="md:text-lg text-base font-light">
                        ...
                        appearance, texture, and flavor. Only cookies that pass
                        our strict criteria make it to our shelves. This
