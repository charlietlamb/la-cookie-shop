  ...
  return (
    ...
    >
      <div className="padding-main">
        <h3 className="font-silk mb-6 text-3xl text-center">Our Process</h3>
        <Tabs
        ...
        >
          <TabsList className="grid w-full grid-cols-3 gap-2 bg-green-600">
            <TabsTrigger
              value="ingredients"
              className="font-silk text-white data-[state=active]:bg-white data-[state=active]:text-dark text-lg"
            >
              Ingredients
            </TabsTrigger>
            <TabsTrigger
            ...
            >
              <TabsContent value="ingredients">
                <Card className="text-green bg-white">
                  <CardHeader>
                    <CardTitle className="font-silk text-dark">
                      Premium Ingredients
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex items-center gap-6">
                      <div className="aspect-square flex items-center justify-center w-1/3 overflow-hidden">
                        <img
